...
<body>
    ...
    <div class="container" style="width:700px;">
        <h3 align="center"> Book Shopping Cart </h3><br />
        <?php
        ...
        ?> <div class="col-md-4">
                    <form method="post" action="index.php?action=add&id=<?php
                                                                        echo $row["id"]; ?>" < div style="border:1px solid #333; background-color:#f1f1f1; border-radius: 5 px;
        padding: 16 px;
        " align="
        center">
        ...
        responsive " /><br />
                        ...
                        <input type="submit" name="add_to_cart" style="margin-top: 5 px;
        " class="
                    ...
                    ?> <tr>
                                ...
                                <td>
                                    <a href="index.php?action=delete&id=<?php echo
                                                                        $values["item_id"]; ?>"> <span class="text-danger"> Remove </span></a>
                                </td>
                            </tr>
                        <?php
